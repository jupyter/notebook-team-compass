...
This page holds resources for members of the Jupyter Notebook team.
...
* [**The Jupyter Notebook Team Compass**](https://github.com/jupyter/notebook-team-compass)
  ...
  etc.
* [**The Jupyter Notebook Team Compass issues**](https://github.com/jupyter/notebook-team-compass/issues)
...
1. **"Watch" the [team compass repository](https://github.com/jupyter/notebook-team-compass)**
...
2. **Stay up-to-date on team meetings**. You can find a notes from previous meetings pinned at
   the [top of the team-compass issues page](https://github.com/jupyter/notebook-team-compass/issues).
...
* **Use your best judgment**. As a member of the Jupyter Notebook team, we trust
